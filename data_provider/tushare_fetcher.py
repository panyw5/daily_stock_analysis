...
"""
===================================
TushareFetcher - 主力数据源 (Priority 0)
===================================
...
class TushareFetcher(BaseFetcher):
    ...
    name = "TushareFetcher"
    priority = 2  # 默认优先级，会在 __init__ 中根据配置动态调整为 0
    ...
    def __init__(self, rate_limit_per_minute: int = 50):
        ...
        Args:
            rate_limit_per_minute: 每分钟最大请求数（默认50，Tushare 120积分配额）
        """
    ...
    def _determine_priority(self) -> int:
        ...
        if config.tushare_token and self._api is not None:
            ...
            logger.info(
                "✅ 检测到 TUSHARE_TOKEN 且 API 初始化成功，Tushare 数据源优先级提升为最高 (Priority 0)"
            )
            return 0
